...
public class JSPFmttagController {
	 ...
	 *  dateStyle : default, short, medium, long, full 중 한가지를 가질 수 있으며, 기본값은 default이다.
	 *  timeStyle : default, short, medium, long, full 중 한가지를 가질 수 있으며, 기본값은 default이다.
	 * 
	 * 4) <fmt:parseDate>
	 * - 문자열을 Date 객체로 변환한다.
	 * 
	...
	// 06) type 속성을 date로 지정하여 날짜 포맷팅을 한다.
	...
	// 07) type 속성을 time으로 지정해야 시간 포맷팅을 한다.
	...
	// 08) type 속성을 both로 지정하여 날짜, 시간 둘 다 포맷팅을 한다.
	...
	public String home0402(Model model) {
		...
		//String dateValue="2023. 2. 1"; // style medium 형태로 지정;
		//String dateValue="2023년 2월 1일 (금)"; // style long 형태로 지정;
		//String dateValue="2023년 2월 1일 금요일"; // style full 형태로 지정;
