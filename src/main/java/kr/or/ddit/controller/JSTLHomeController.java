...
public class JSTLHomeController {
	 ...
	 * 		<c:out>			|	JSPWriter에 값을 적정하게 처리한 후에 출력한다.
	 ...
	 * 	<fmt:formatDate>	|	Date 객체를 문자열로 반환한다.
	 ...
	 * 	<fn:substring>			| 문자열 배열을 결합해서 하나의 문자열을 만든다.
	 * 	<fn:substring>			| 문자열을 구분자로 분할해서 문자여 배열을 만든다.
	 * 
	...
	public String home1001(String keyword, Model model) {
