...
<body>
	...
	<h3>Register ModelAttribute Form</h3>
	<h3>3. @ModelAttribute 어노테이션</h3>
	<hr>
	
	<p>1) 기본 자료형은 매개변수로 선언했을때 전달되는지 확인</p>
	<form action="/modelattribute/register01" method="post">
		userId : <input type="text" name="userId" value="hongkd"><br/>
		passowrd : <input type="text" name="password" value="1234"><br/>
		<input type="submit" value="register01"><br/> 
	</form>
	
	
	<p>2) 기본자료형인 매개변수에 @ModelAttribute 어노테이션을 지정하여 데이터를 전달한다.</p>
