...
//							파일 전송의 경우 쿼리스트링을 사용하지 않으므로 해당 설정을 false로 설정
			// contentType : Content-Type 설정 시, 사용하는데 해당 설정의 기본값은
//			 				'application/x-www-form-urlencoded; charset=utf-8'입니다.
//							때문에 기본값으로 나가지 않고 'multipart/form-data'로 나갈수 있도록 설정을 false로 한다.
//							request 요청에서 content-type을 확인해보면 'multipart/form-data'; 'boundary=====webkitformBoundary[hashKey]'
//							의 값으로 전송된 것을 확인할 수 있다.
...
function isImageFile(file){
	...
	return ($.inArray(ext, ["jpg", "jpeg", "gif", "png", "webp", "pdf"]) === -1) ? false : true; 
}
