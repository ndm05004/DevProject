	...
	<div class="row">
		<div class="col-md-12">
			<div class="card card-primary">
				...
				<form action="/notice/insert.do" enctype="multipart/form-data" method="post" id="noticeForm">
					<c:if test="${status eq 'u' }">
					...
					<div class="card-body">
						<div class="form-group">
							<label for="boTitle">제목을 입력해주세요</label> <input type="text"
								id="boTitle" value="${notice.boTitle }" class="form-control" name="boTitle" placeholder="제목을 입력해주세요">
						</div>
						<div class="form-group">
...
<script>
	$(function() {
		...
		insertBtn.on("click", function(){
			title = $("#boTitle").val(); 					  // 제목
			content = CKEDITOR.instances.boContent.getData(); // 내용
